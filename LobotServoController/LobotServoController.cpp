...
void LobotServoController::sendCMDReadServoPos(uint8_t servoID)
{
    uint8_t buf[7];
    if (servoID > 31) {
		return;
...
// void LobotServoController::readServoPos(uint8_t servoID)
// {
//     sendCMDReadServoPos(uint8_t servoID)
//     return
//     uint8_t buf[8];
//     buf[0] = FRAME_HEADER;
//     buf[1] = FRAME_HEADER;
